...
<template>
  ...
  <base-input label="Subject" type="text" placeholder="Enter Subject" v-model="taskToAdd.subject"></base-input>
  <base-input label="DueDate" type="text" placeholder="Enter DueDate" v-model="taskToAdd.dueDate"></base-input>
  <base-input label="Priority" type="text" placeholder="Enter Priority" v-model="taskToAdd.priority"></base-input>
                  </form>
                </div>
