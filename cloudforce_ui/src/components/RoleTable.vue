...
<template>
  ...
  <base-input label="Name" type="text" placeholder="Enter Name" v-model="roleToAdd.name"></base-input>
  <base-input label="Description" type="text" placeholder="Enter Description" v-model="roleToAdd.description"></base-input>
                  </form>
                </div>
