            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Subject</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Subject" type="text" placeholder="Enter Subject" v-model="taskDetails.subject"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					...
					<td class="detail_view_column_2">Priority</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Priority" type="text" placeholder="Enter Priority" v-model="taskDetails.priority"></input>
																		</div>
						</td>
														</tr>
