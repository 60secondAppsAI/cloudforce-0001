              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Account Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Account Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="AccountName" type="text" placeholder="Enter AccountName" v-model="accountDetails.accountName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Account Type</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="AccountType" type="text" placeholder="Enter AccountType" v-model="accountDetails.accountType"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Industry</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Industry" type="text" placeholder="Enter Industry" v-model="accountDetails.industry"></input>
																		</div>
						</td>
														</tr>
